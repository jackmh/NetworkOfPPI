...
<body>
	<%
		HttpSession hs = request.getSession();
			...
			String PPIType = (String) hs.getAttribute("PPIType");
	...
	<div class="container">
		<div class="page-header">
			...
			<h3 class="text-muted">
				Gene Interaction Type of <%=PPIType %> Results
			</h3>
			<p class="lead">Pubmed Text Analysis.</p>
		</div>

		<p>PPI Type Recognition.</p>
		<hr>
		<table id="PPITypeResult"
